...
function realizarAnaliseLexica($codigo, $linguagem) {
    ...
    switch ($linguagem) {
        case 'php':
            ...
            break;
        case 'python':
            $padraoPalavrasChave = "/\b(if|else|for|while|def|class|import|elif|print|try|except|finally)\b/";
            $padraoIdentificadores = "/\b(?!(if|else|for|while|def|class|import|elif|print|try|except|finally))\b[a-zA-Z_][a-zA-Z0-9_]*\b/";
